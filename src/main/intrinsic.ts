...
export const getDocumentActiveElement = (): Element =>
  apply(DocumentActiveElementGetter, document, [])
// #endregion
// #region CustomEvent.prototype.detail
const CustomEventDetailGetter = Object.getOwnPropertyDescriptor(
  CustomEvent.prototype,
  'detail'
)!.get!
export const getCustomEventDetail = (e: CustomEvent) =>
  apply(CustomEventDetailGetter, e, [])
// #endregion
// #region new Map()
const { Map: _xray_Map } = globalThis
const XRayMapOriginalProtoDesc = Object.getOwnPropertyDescriptors(
  _xray_Map.prototype
)
...
export const _XPCNativeWrapper =
